...
class ContactRole(Base):
    """Lista configurável de valores para o campo core `contact_role` de Contato."""

    __tablename__ = "crm_contact_roles"
    __table_args__ = (
        UniqueConstraint("business_unit_id", "value", name="uq_crm_contact_roles_bu_value"),
    )

    id: Mapped[str] = mapped_column(String(18), primary_key=True, default=lambda: new_id18("CRL"))
